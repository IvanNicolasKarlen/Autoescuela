        ...
        <div class="row">
            <div class="col-lg-12 p-b-30">
                <div class="t-center">
					...
					<form action="agregarInstructor-2" method="get">
						<label class="txt9"> Seleccione Especialidad: </label> 
						<select class="bo-rad-10 sizefull txt10 p-l-20" id="idE" name="idE">

							<c:forEach items="${especialidades}" var="les">      
