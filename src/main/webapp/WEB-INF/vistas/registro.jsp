    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 p-b-30">
                ...
                <form:form class="wrap-form-reservation size22 m-l-r-auto" method="POST" modelAttribute="usuario" action="realizarRegistro">
                    <div class="row">
                        <div class="col-md-4">
                            <!-- Date -->
                            <span class="txt9">
                            ...
                            <div class="wrap-inputdate pos-relative txt10 size12 bo2 bo-rad-10 m-t-3 m-b-23">
                                <form:input class="bo-rad-10 sizefull txt10 p-l-20"
                                       type="text" id="nombre" path="nombre"></form:input>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <!-- Date -->
                            ...
                            <div class="wrap-inputdate pos-relative txt10 size12 bo2 bo-rad-10 m-t-3 m-b-23">
                                <form:input class="bo-rad-10 sizefull txt10 p-l-20"
                                       type="text" id="apellido" path="apellido"></form:input>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <!-- Date -->
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="wrap-inputdate pos-relative txt10 size12 bo2 bo-rad-10 m-t-3 m-b-23">
                                <input class="bo-rad-10 sizefull txt10 p-l-20"
                                       type="password" id="pass2" name="pass2"></input>
                            </div>
                        </div>
