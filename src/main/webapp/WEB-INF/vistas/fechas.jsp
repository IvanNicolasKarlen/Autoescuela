        ...
        <div class="row">
            <div class="col-lg-12 p-b-30">
                <div class="t-center">
				 ...
				 <input type="text" style="background-color:white;" class="form-control input-lg border border-dark mx-sm-3 mb-2 text-center" id="from" name="from" readonly="readonly" required placeholder="Dia/Mes/Año"/>
